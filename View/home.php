    ...
    <div class="row row-mt-15em">
        ...
        <div class="col-md-6  animated fadeInRight">
            <div class="col-md-10 offset-1  animated fadeInRight">
                <form id="formulaire" method="post" action="../Controller/devis_controller.php" enctype="multipart/form-data">
                    <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>Address</label>
                        <input type="text" class="form-control" name="adresse" placeholder="Num 34, Rue 'A', Secteur 'AB' ">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Wilaya</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="specifics">
                    </div>
                    <div class="form-group">
                        <label class="">Documents a traduire</label>
                        <input id="filename" type='file' name='files[]' multiple />
                    </div>
                    <div class="custom-control custom-checkbox">
                        <label>Trducteur Assermente</label>
                        <input type="text" class="form-control" name="typetraducteur" placeholder=" oui/non">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <div class="captcha">
