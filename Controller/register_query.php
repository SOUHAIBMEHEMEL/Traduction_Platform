...
if(isset($_POST['register']))
{
    ...
    else
    {
        try
        {
            $stmt = $DB_con->prepare("SELECT user_name,user_email FROM client WHERE user_name=:uname OR user_email=:umail");
            ...
            {
                if($user->register($firstname,$lastname,$uname,$email,$password,$phone,$fax,$wilaya,$commune,$adresse))
                {
